module "vpc" {
  source                = "github.com/crlealb/AUY1105-Infraestructura-como-codigo-II//EA2/ACT2.5/vpc_module?ref=v1.0.1"
...
module "ec2" {
  source        = "github.com/crlealb/AUY1105-Infraestructura-como-codigo-II//EA2/ACT2.5/ec2_module?ref=v1.0.1"
